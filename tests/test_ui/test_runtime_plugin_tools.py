...
from myharness.ui.runtime import build_runtime, close_runtime
...
async def test_build_runtime_registers_enabled_plugin_tools(tmp_path: Path, monkeypatch):
    ...
    monkeypatch.setattr("myharness.ui.runtime.load_settings", lambda: Settings(allow_project_plugins=True))
