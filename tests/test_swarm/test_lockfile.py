...
from myharness.swarm import lockfile
from myharness.utils import file_lock
...
def test_exclusive_file_lock_routes_windows_branch(monkeypatch, tmp_path: Path):
    ...
    # The implementation lives in ``myharness.utils.file_lock``;
    # ``myharness.swarm.lockfile`` re-exports it for backwards compatibility.
