...
def test_ui_design_essence_is_supporting_quality_guardrail_not_primary_creator():
    skill_text = (ROOT / ".skills" / "General" / "ui-design-essence" / "SKILL.md").read_text(encoding="utf-8")
...
def test_ui_design_essence_openai_metadata_matches_supporting_scope():
    openai_yaml = (ROOT / ".skills" / "General" / "ui-design-essence" / "agents" / "openai.yaml").read_text(encoding="utf-8")
