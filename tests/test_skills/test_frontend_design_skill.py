...
def test_frontend_design_skill_is_scoped_to_sites_and_app_ui_not_reports():
    skill_text = (ROOT / ".skills" / "General" / "frontend-design" / "SKILL.md").read_text(encoding="utf-8")
    ...
    assert "use visual-artifact for those report deliverables" in skill_text
