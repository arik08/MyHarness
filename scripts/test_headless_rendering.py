...
async def test_markdown_render() -> tuple[bool, str]:
    ...
    from myharness.ui.output import OutputRenderer
    from myharness.engine.stream_events import AssistantTextDelta, AssistantTurnComplete
...
async def test_tool_output_format() -> tuple[bool, str]:
    ...
    from myharness.ui.output import OutputRenderer
    from myharness.engine.stream_events import ToolExecutionStarted, ToolExecutionCompleted
...
async def test_real_model_headless() -> tuple[bool, str]:
    ...
    from myharness.ui.app import run_print_mode
