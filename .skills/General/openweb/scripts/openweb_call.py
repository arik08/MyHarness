...
def _usage() -> str:
    return (
        ...
        "  python .skills/General/openweb/scripts/openweb_call.py <site>\n"
        "  python .skills/General/openweb/scripts/openweb_call.py <site> <operation> '<json-params>'\n"
        "  python .skills/General/openweb/scripts/openweb_call.py <site> <operation> key=value [key=value ...]\n"
        "\n"
        "Examples:\n"
