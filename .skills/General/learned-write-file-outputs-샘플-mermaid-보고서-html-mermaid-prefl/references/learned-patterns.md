...
- Lesson: A repeated failure was observed and later verified as resolved: write_file input=outputs/샘플_mermaid_보고서.html: Mermaid preflight failed; 샘플_mermaid_보고서.html was not written.
