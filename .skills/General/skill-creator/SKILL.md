...
```bash
scripts/init_skill.py my-skill --path ./.skills/POSCO_Skill
scripts/init_skill.py my-skill --path ./.skills/POSCO_Skill --resources scripts,references
