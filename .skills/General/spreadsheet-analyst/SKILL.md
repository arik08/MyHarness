...
```bash
python .skills/General/spreadsheet-analyst/scripts/workbook_audit.py outputs/report.xlsx
python .skills/General/spreadsheet-analyst/scripts/workbook_audit.py data/source.csv
```
