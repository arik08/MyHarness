...
- Use `visual-artifact` for long scrolling HTML reports, dashboards, infographics, microsites, and ordinary web reports.
- Use this skill for `A4 landscape`, `A4 가로`, `가로형 A4`, `PDF용 가로 보고서`, `인쇄용 가로 보고서`, `A4 한 장/여러 장`, or fixed-page report requests.
