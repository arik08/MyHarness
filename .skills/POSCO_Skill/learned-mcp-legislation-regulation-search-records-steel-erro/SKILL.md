---
name: learned-mcp-legislation-regulation-search-records-steel-erro
description: >
  Use when MyHarness sees this repeated verified failure pattern: mcp__legislation-
  regulation__search_records input=steel: Error executing tool search_records: EUR-Lex
  CELLAR request failed. Check the credential, service statu
---

# learned-mcp-legislation-regulation-search-records-steel-erro
...
## When To Use
- Use when MyHarness sees this repeated verified failure pattern: mcp__legislation-regulation__search_records input=steel: Error executing tool search_records: EUR-Lex CELLAR request failed. Check the credential, service statu
...
- Start by applying the verified corrective path: Loaded skill legislation-regulation
