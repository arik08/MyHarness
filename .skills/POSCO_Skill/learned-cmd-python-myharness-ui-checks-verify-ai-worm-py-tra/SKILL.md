...
description: >
  ...
  .myharness/ui-checks/verify_ai_worm.py: Traceback (most recent call last):
---
...
## When To Use
- Use when MyHarness sees this repeated verified failure pattern: cmd input=python .myharness/ui-checks/verify_ai_worm.py: Traceback (most recent call last):
...
- Start by applying the verified corrective path: Ran command python .myharness/ui-checks/verify_ai_worm.py [before_pause 05 RUNNING · 5× SPEED PAUSE]
