---
name: learned-mcp-development-finance-get-source-health-error-exec
description: >
  Use when MyHarness sees this repeated verified failure pattern: mcp__development-
  finance__get_source_health: Error executing tool get_source_health: Unknown source. Use
  adb_kidb; World Bank uses the existing worldbank MCP.
---

# learned-mcp-development-finance-get-source-health-error-exec
...
## When To Use
- Use when MyHarness sees this repeated verified failure pattern: mcp__development-finance__get_source_health: Error executing tool get_source_health: Unknown source. Use adb_kidb; World Bank uses the existing worldbank MCP.
...
- Start by applying the verified corrective path: Loaded skill environment-industry
