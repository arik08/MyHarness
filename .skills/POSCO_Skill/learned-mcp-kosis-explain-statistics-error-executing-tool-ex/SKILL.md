---
name: learned-mcp-kosis-explain-statistics-error-executing-tool-ex
description: >
  Use when MyHarness sees this repeated verified failure pattern:
  mcp__kosis__explain_statistics: Error executing tool explain_statistics: KOSIS API error
  30: 데이터가 존재하지 않습니다.
---

# learned-mcp-kosis-explain-statistics-error-executing-tool-ex
...
## When To Use
- Use when MyHarness sees this repeated verified failure pattern: mcp__kosis__explain_statistics: Error executing tool explain_statistics: KOSIS API error 30: 데이터가 존재하지 않습니다.
...
- Start by applying the verified corrective path: Loaded skill kosis
