---
name: learned-mcp-legislation-regulation-search-records-steel-carb
description: >
  Use when MyHarness sees this repeated verified failure pattern: mcp__legislation-
  regulation__search_records input=steel carbon: Error executing tool search_records:
  CELEX number has an invalid format.
---

# learned-mcp-legislation-regulation-search-records-steel-carb
...
## When To Use
- Use when MyHarness sees this repeated verified failure pattern: mcp__legislation-regulation__search_records input=steel carbon: Error executing tool search_records: CELEX number has an invalid format.
