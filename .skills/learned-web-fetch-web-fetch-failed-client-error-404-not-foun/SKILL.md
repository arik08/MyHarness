...
description: Use when MyHarness sees this repeated verified failure pattern: web_fetch: web_fetch failed: Client error '404 Not Found' for url 'https://raw.githubusercontent.com/HKUDS/OpenHarness/main/THIRD_PARTY_NOTICES.md'
---
...
## When To Use
- Use when MyHarness sees this repeated verified failure pattern: web_fetch: web_fetch failed: Client error '404 Not Found' for url 'https://raw.githubusercontent.com/HKUDS/OpenHarness/main/THIRD_PARTY_NOTICES.md'
