...
When answering, preserve source identifiers from the MCP result: `document_name`, `source_path`, `heading_path`, and `lines`. If results come from both documents, group the answer by `document_name` instead of merging them silently.
