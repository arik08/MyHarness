...
const starterPrompts: StarterPrompt[] = [
  {
    category: "보고서 작성",
    title: "주제 조사 보고서",
    prompt: "[조사 주제]에 대해 최신 자료를 조사하고, 핵심 쟁점·시장/산업 영향·시사점을 포함한 HTML 보고서로 작성해줘. 표와 차트가 필요하면 함께 넣어줘.",
    icon: "report",
  },
  {
    category: "경쟁사 분석",
    title: "경쟁사 이슈 비교",
    prompt: "(주)포스코의 해외 주요 경쟁사를 정의하고, 포스코를 포함한 각 회사별 올해 주요 이슈를 뉴스 기사 기반으로 분석해줘. 회사별 전략, 리스크, 시사점을 표로 정리해줘.",
    icon: "competitor",
  },
  {
    category: "공시 분석",
    title: "DART 공시 분석",
    prompt: "[회사명]에 대해 DART 공시정보를 기반으로 최근 실적, 주요 사업, 투자·리스크 요인을 분석해줘. 중요한 공시 항목과 해석을 표로 정리해줘.",
    icon: "disclosure",
  },
  {
    category: "영상 분석",
    title: "유튜브 내용 분석",
    prompt: "[YouTube 링크]에서 설명하는 내용을 요약하고, 핵심 주장·근거·반박 가능성·업무에 참고할 시사점으로 나눠 분석해줘.",
    icon: "video",
  },
  {
    category: "데이터 분석",
    title: "표 데이터 보고서",
    prompt: "아래 숫자 데이터를 분석해서 주요 추세, 이상치, 원인 가설, 의사결정 포인트를 정리하고 HTML 보고서로 작성해줘. 가능하면 차트도 포함해줘.\n\n[표 데이터 붙여넣기]",
    icon: "data",
  },
  {
    category: "엑셀 모델",
    title: "투자수익성 모델",
    prompt: "포스코의 인도 일관제철소 투자와 관련해 투자수익성 검토 모델을 엑셀로 만들어줘. 주요 가정, 매출·비용·CAPEX·현금흐름·NPV·IRR·민감도 분석 시트를 포함해줘.",
    icon: "spreadsheet",
  },
  {
    category: "Workflow",
    title: "업무 흐름 다이어그램",
    prompt: "포스코 투자관리그룹의 주요 업무를 조사하고, 업무 단계·담당 역할·산출물·의사결정 지점을 정리해줘. 마지막에는 workflow diagram으로 표현해줘.",
    icon: "workflow",
  },
  {
    category: "프로그램",
    title: "AI 지렁이 게임",
    prompt: "절대로 죽지 않는 알고리즘이 반영된 AI 지렁이 게임을 HTML로 만들어줘. 먹이는 5개, 이동속도는 정상 수준의 5배, 죽으면 1초 뒤 자동 재시작되게 해줘.",
    icon: "code",
  },
  {
    category: "3D 모델",
    title: "태양계 시뮬레이터",
    prompt: "태양계 행성 궤도 시뮬레이터를 HTML로 만들어줘. 행성들이 태양 주변을 공전하고, 속도 조절·일시정지·행성 이름 표시 기능을 포함해줘.",
    icon: "model",
  },
];
