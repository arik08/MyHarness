...
if TYPE_CHECKING:
    ...
    from myharness.sandbox.docker_backend import DockerSandboxSession
...
async def start_docker_sandbox(
    ...
    """Start a Docker sandbox session for the current MyHarness session."""
    global _active_session  # noqa: PLW0603

    from myharness.sandbox.docker_backend import DockerSandboxSession, get_docker_availability
