...
from myharness.config.schema import Config
...
class ChannelManager:
    ...
    def _init_channels(self) -> None:
        ...
        if self.config.channels.telegram.enabled:
            try:
                from myharness.channels.impl.telegram import TelegramChannel
        ...
        if self.config.channels.whatsapp.enabled:
            try:
                from myharness.channels.impl.whatsapp import WhatsAppChannel
        ...
        if self.config.channels.discord.enabled:
            try:
                from myharness.channels.impl.discord import DiscordChannel
        ...
        if self.config.channels.feishu.enabled:
            try:
                from myharness.channels.impl.feishu import FeishuChannel
        ...
        if self.config.channels.mochat.enabled:
            try:
                from myharness.channels.impl.mochat import MochatChannel
        ...
        if self.config.channels.dingtalk.enabled:
            try:
                from myharness.channels.impl.dingtalk import DingTalkChannel
        ...
        if self.config.channels.email.enabled:
            try:
                from myharness.channels.impl.email import EmailChannel
        ...
        if self.config.channels.slack.enabled:
            try:
                from myharness.channels.impl.slack import SlackChannel
        ...
        if self.config.channels.qq.enabled:
            try:
                from myharness.channels.impl.qq import QQChannel
        ...
        if self.config.channels.matrix.enabled:
            try:
                from myharness.channels.impl.matrix import MatrixChannel
