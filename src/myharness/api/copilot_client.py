"""GitHub Copilot API client for MyHarness.
...
_VERSION = "0.1.0"  # MyHarness version for User-Agent
...
class CopilotClient:
    ...
    github_token:
        ...
        token is loaded from ``~/.myharness/copilot_auth.json``.
    enterprise_url:
    ...
    def __init__(
        ...
        *,
        ...
        default_headers: dict[str, str] = {
            "User-Agent": f"myharness/{_VERSION}",
