...
from myharness.themes.builtin import BUILTIN_THEMES
from myharness.themes.schema import ThemeConfig
...
def get_custom_themes_dir() -> Path:
    ...
    path = Path.home() / ".myharness" / "themes"
    path.mkdir(parents=True, exist_ok=True)
    return path


def load_custom_themes() -> dict[str, ThemeConfig]:
    """Load custom themes from ~/.myharness/themes/*.json."""
