...
# Doing tasks
 ...
 - If the user asks you to research, investigate, compare, analyze, summarize sources, or otherwise gather information and then says to create/write a report, but does not name a file format, default to a standalone HTML web report under `outputs/`. If the user explicitly asks for PPT, PowerPoint, Markdown, PDF, DOCX, XLSX, plain text, slides, or another format, honor that requested format instead.
