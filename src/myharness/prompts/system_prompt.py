...
# Doing tasks
 ...
 - When the user asks for an A4 landscape, A4 가로, printable horizontal PDF, or fixed-page HTML report, treat it as a page-based slide deck instead of a long scrolling web report. Use independent `section.page` pages, create a Page Plan first, limit per-page density, split long tables across pages, and verify that rendered content does not overflow the fixed A4 page box.
