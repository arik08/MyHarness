"""Unified authentication manager for MyHarness providers."""
...
from myharness.auth.storage import (
...
# Providers that MyHarness knows about.
_KNOWN_PROVIDERS = [
    "anthropic",
    "anthropic_claude",
    "openai",
...
class AuthManager:
    ...
    Reads/writes credentials via :mod:`myharness.auth.storage` and keeps
    ...
    def get_auth_source_statuses(self) -> dict[str, Any]:
        ...
        from myharness.auth.external import describe_external_binding
        ...
        for source in _AUTH_SOURCES:
            ...
            if source == "anthropic_api_key":
                ...
                from myharness.auth.external import default_binding_for_provider
                ...
                from myharness.api.copilot_auth import load_copilot_auth
    ...
    def get_auth_status(self) -> dict[str, Any]:
        ...
        for provider in _KNOWN_PROVIDERS:
            ...
            if provider == "anthropic":
                ...
                from myharness.auth.external import default_binding_for_provider, describe_external_binding
