"""Credential storage for MyHarness.

Default backend: ~/.myharness/credentials.json with mode 600.
...
def _obfuscation_key() -> bytes:
    ...
    seed = str(Path.home()).encode() + b"myharness-v1"
    import hashlib
