...
from myharness.bridge.manager import BridgeSessionManager, BridgeSessionRecord, get_bridge_manager
from myharness.bridge.session_runner import SessionHandle, spawn_session
from myharness.bridge.types import BridgeConfig, WorkData, WorkSecret
